...
#'
#' @export
d <- read.csv("OnlineNewsPopularity2.csv", header = T, sep = ',')
MyData <- read.csv(file="/Users/April30/Downloads/OnlineNewsPopularity22.csv", header=TRUE, sep=",")
MyData[1,47]
...
df <- as.data.frame(fscore(MyData,48,1:46))
